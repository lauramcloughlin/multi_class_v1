...
from .page_content import build_index_content, build_statistics_content, build_pos_content, \
    build_whole_ds_feature_analysis_content, build_feature_analysis_content, build_misclassified_feature_analysis_content
...
from .build import create_directory, create_image_directory, create_page, open_website, copy_css, copy_js_folder, move_images
...
class Misclass(object):
    ...
    def build(self, X, y, y_pred_label, word_count_matrix, tfidf_matrix, all_word_count_matrix, model_desc, path):
        ...
        avg_unique_tokens = get_feature_statistics_avg(data_matrix['unique_tokens'], "unique_tokens", y, y_pred_label, labels)
        ...
        avg_non_alphanumeric = get_feature_statistics_avg(data_matrix['non_alphanumeric'], "non_alphanumeric", y, y_pred_label, labels)
        ...
        avg_misspellings = get_feature_statistics_avg(data_matrix['misspellings'], "misspellings", y, y_pred_label, labels)
        ...
        feature_statistics_df = pd.concat([ds_record_count, avg_sentences, avg_words, avg_unique_tokens, avg_chars,
                                           avg_uppercase, avg_lowercase, avg_numbers, avg_non_alphanumeric, avg_punctuation,
        ...
        avg_unique_tokens2 = get_feature_statistics_avg2(data_matrix['unique_tokens'], "unique_tokens", y, y_pred_label, labels)
        ...
        avg_non_alphanumeric2 = get_feature_statistics_avg2(data_matrix['non_alphanumeric'], "non_alphanumeric", y, y_pred_label, labels)
        avg_punctuation2 = get_feature_statistics_avg2(data_matrix['punctuation'], "punctuation", y, y_pred_label, labels)
        avg_space2 = get_feature_statistics_avg2(data_matrix['space'], "space", y, y_pred_label, labels)
        avg_misspellings2 = get_feature_statistics_avg2(data_matrix['misspellings'], "misspellings", y, y_pred_label, labels)
        #  Joining Second Feature Statistics table
        feature_statistics_df2 = pd.concat([ds_record_count2, avg_sentences2, avg_words2, avg_unique_tokens2, avg_chars2,
        ...
        avg_unique_tokens3 = get_feature_statistics_avg3(data_matrix['unique_tokens'], y, y_pred_label, labels,"unique_tokens")
        ...
        avg_non_alphanumeric3 = get_feature_statistics_avg3(data_matrix['non_alphanumeric'], y, y_pred_label, labels,"non_alphanumeric")
        avg_punctuation3 = get_feature_statistics_avg3(data_matrix['punctuation'], y, y_pred_label, labels,"punctuation")
        avg_space3 = get_feature_statistics_avg3(data_matrix['space'], y, y_pred_label, labels,"space")
        avg_misspellings3 = get_feature_statistics_avg3(data_matrix['misspellings'], y, y_pred_label, labels,"misspellings")
        ...
        index_content = build_index_content(model_desc, time_elapsed, record_count, label_count,
                                            ...
                                            accuracy, misclassification_rate, confusion_matrix, classification_report, f1_score, misclassifications)

        statistics_content = build_statistics_content(feature_statistics_df, feature_statistics_df2, classifications, ds_record_count3, avg_sentences3,
